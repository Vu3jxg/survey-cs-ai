...
import whiteLogo from '../assets/logos/NITK_white.png'
...
export default function Details({lang, setLang}: DetailsProps) { 
    ...
    return (
        <div className="relative p-6 max-w-screen-md mx-auto bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-gray-700">
            {/* Watermark Container */}
            <div className="absolute inset-0 flex flex-col items-center justify-center z-[-1] pointer-events-none opacity-30">
                <img src={whiteLogo} alt="Watermark Logo" className="w-48 h-auto mb-2" />
                <div className="text-white font-bold text-xl text-shadow-neon-purple">
            ...
            <div className="flex flex-row px-12 py-3 items-center justify-between">
                <button 
                    ...
                    onClick={() => handleSelect('Kannada')}>Kannada
                </button>
                <button 
                    ...
                    onClick={() => handleSelect('Hindi')}>Hindi
                </button>
                <button 
                    ...
                    onClick={() => handleSelect('English')}>English
                </button>
            </div>
            {lang.isSet && (
