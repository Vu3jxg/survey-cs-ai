              ...
              <div className="relative w-full">
                <div className="flex flex-col items-center relative">
                  ...
                  <div className="relative w-full px-4 flex justify-center items-center">
                    ...
                    <div className="absolute left-10 top-0 flex flex-col items-center w-1/5">
                    ...
                    {/* Contact Info (Right) */}
                    <div className="absolute right-10 top-0 w-1/5 bg-white shadow-lg p-4 rounded-lg">
                      <h2 className="text-xl font-bold mb-0 text-gray-800">Contact Information</h2>
                      <p className="text-gray-700">
                        <strong>Landline:</strong> +91-824-2473402
                      </p>
                      <p className="text-gray-700">
                        <strong>Email:</strong> projectcihub@gmail.com
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative mt-16 py-2">
                  ...
                  {/* Content div with developer images and motion */}
